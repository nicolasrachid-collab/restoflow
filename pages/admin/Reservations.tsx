      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex gap-2">
            <input 
                ...
                className="px-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-indigo-500"
            />
            ...
            todaysReservations.map(res => (
                <div key={res.id} className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4 animate-slide-up">
                    <div className="flex gap-4 items-center">
                        <div className="bg-indigo-50 text-indigo-700 font-bold text-xl p-4 rounded-lg text-center min-w-[80px]">
                    ...
                    <div className="flex items-center gap-3 w-full md:w-auto">
                        <span className={`px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider
                            ...
                            ${res.status === ReservationStatus.CONFIRMED ? 'bg-blue-100 text-blue-800' : ''}
