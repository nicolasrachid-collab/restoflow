        ...
        {resultText && (
          <div className="space-y-6 animate-fade-in">
            <div className="prose max-w-none">
              ...
              <div className="p-4 bg-orange-50 rounded-lg text-gray-800 whitespace-pre-wrap">
                {resultText}
              </div>
            </div>
                    ...
                    if (web) {
                      return (
                        <a key={idx} href={web.uri} target="_blank" rel="noreferrer" className="flex items-center gap-3 p-3 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors group">
                          <div className="bg-orange-100 p-2 rounded-md text-orange-600 group-hover:bg-orange-200">
